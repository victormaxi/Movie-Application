...
namespace Movie_Client.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public MovieController(IOptionsSnapshot<ApiRequestUri> options)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> AddMovie(MovieDtoModel model)
        {
            try
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    var uri = string.Format(_apiRequestUri.AddMovie, model);
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                using (var httpClient = new HttpClient())
                {
                    ...
                    var uri = string.Format(_apiRequestUri.GetAllMovie);
